...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="bg-[#F0F2F5] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
...
<svg class="w-6 h-6 text-[#1DA1F2]" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
  <path d="M20 6a8.1 8.1 0 0 1-2.34.64 4.07 4.07 0 0 0 1.79-2.25 8.16 8.16 0 0 1-2.6 1A4.07 4.07 0 0 0 12 8a11.54 11.54 0 0 1-8.39-4.25 4.07 4.07 0 0 0 1.26 5.43A4.04 4.04 0 0 1 3 8.27v.05a4.07 4.07 0 0 0 3.26 3.99 4.1 4.1 0 0 1-1.85.07 4.07 4.07 0 0 0 3.8 2.83A8.18 8.18 0 0 1 2 18.57a11.53 11.53 0 0 0 6.29 1.84c7.55 0 11.68-6.26 11.68-11.68 0-.18 0-.35-.01-.53A8.36 8.36 0 0 0 20 6z"/>
</svg>
                                    <span>Share your thoughts in real-time</span>
                                </li>
                                <li class="flex items-center gap-3">
                                    <svg class="w-6 h-6 text-[#1DA1F2]" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 0a12 12 0 1 0 12 12A12 12 0 0 0 12 0zm0 22a10 10 0 1 1 10-10 10 10 0 0 1-10 10zm5-10a5 5 0 0 1-5 5 1 1 0 0 1 0-2 3 3 0 0 0 3-3 1 1 0 0 1 2 0z"/>
                                    </svg>
                                    <span>Join trending conversations</span>
                                </li>
                                <li class="flex items-center gap-3">
                                    <svg class="w-6 h-6 text-[#1DA1F2]" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 4a4 4 0 1 0 4 4 4 4 0 0 0-4-4zm0 6a2 2 0 1 1 2-2 2 2 0 0 1-2 2zm0 11a8 8 0 0 1-8-8 1 1 0 0 1 2 0 6 6 0 0 0 12 0 1 1 0 0 1 2 0 8 8 0 0 1-8 8z"/>
                                    </svg>
                        ...
                        <div class="pt-6">
                            <a href="{{ route('register') }}" class="inline-block w-full text-center bg-[#1DA1F2] hover:bg-[#1991db] text-white px-8 py-3 rounded-full font-medium transition-colors">
                                Get Started
                            </a>
                        </div>
                    </div>
                ...
                <div class="bg-[#E8F5FE] dark:bg-[#192734] rounded-lg lg:w-1/2 overflow-hidden">
                    <div class="p-8 text-center">
                        ...
                        <h2 class="text-2xl font-bold mb-4 text-gray-200">Join Chirper today</h2>
